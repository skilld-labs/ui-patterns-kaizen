...
---
{
  ...
  "repository": "git@github.com:skilld-labs/ui-patterns-kaizen.git",
  "author": "Skilld",
  "license": "MIT",
  "devDependencies": {
    "@skilld/ui-patterns-kaizen-cg": "^1.0.0-alpha.0",
  ...
  "dependencies": {
    ...
    "@skilld/ui-patterns-kaizen-breakpoints": ^1.0.0-alpha.0",
    "@skilld/ui-patterns-kaizen-core": ^1.0.0-alpha.0",
    "autoprefixer": "^10.4.4",
  ...
  "scripts": {
    ...
    "cc": "npx @skilld/ui-patterns-kaizen-cg --theme_name=<%= h.changeCase.snakeCase(name) %>",
