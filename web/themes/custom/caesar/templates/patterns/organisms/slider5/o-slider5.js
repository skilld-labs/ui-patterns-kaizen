...
const r$2 = (t2) => new o$3('string' == typeof t2 ? t2 : t2 + '', void 0, s$3),
  i$1 = (t2, ...e2) => {
    const n2 =
      1 === t2.length
        ? t2[0]
  ...
  S$1 = (s2, n2) => {
    e$2
      ? (s2.adoptedStyleSheets = n2.map((t2) =>
          t2 instanceof CSSStyleSheet ? t2 : t2.styleSheet,
        ))
      : n2.forEach((e2) => {
          const n3 = document.createElement('style'),
            o3 = t$1.litNonce;
          void 0 !== o3 && n3.setAttribute('nonce', o3),
            (n3.textContent = e2.cssText),
            s2.appendChild(n3);
        });
  },
  c$1 = e$2
...
let u$1 = class u extends HTMLElement {
  ...
  static addInitializer(t2) {
    var i2;
    this.finalize(),
      (null !== (i2 = this.h) && void 0 !== i2 ? i2 : (this.h = [])).push(t2);
  }
  ...
  _$Eu() {
    var t2;
    (this._$E_ = new Promise((t3) => (this.enableUpdating = t3))),
      (this._$AL = /* @__PURE__ */ new Map()),
      this._$Eg(),
      this.requestUpdate(),
      null === (t2 = this.constructor.h) ||
        void 0 === t2 ||
        t2.forEach((t3) => t3(this));
  }
  addController(t2) {
    var i2, s2;
    (null !== (i2 = this._$ES) && void 0 !== i2 ? i2 : (this._$ES = [])).push(
      t2,
    ),
      void 0 !== this.renderRoot &&
        this.isConnected &&
        (null === (s2 = t2.hostConnected) || void 0 === s2 || s2.call(t2));
  }
  removeController(t2) {
    var i2;
    null === (i2 = this._$ES) ||
      void 0 === i2 ||
      i2.splice(this._$ES.indexOf(t2) >>> 0, 1);
  }
  _$Eg() {
  ...
  createRenderRoot() {
    var t2;
    const s2 =
      null !== (t2 = this.shadowRoot) && void 0 !== t2
        ? t2
  ...
  connectedCallback() {
    ...
    void 0 === this.renderRoot && (this.renderRoot = this.createRenderRoot()),
      ...
      null === (t2 = this._$ES) ||
        ...
        t2.forEach((t3) => {
          var i2;
          return null === (i2 = t3.hostConnected) || void 0 === i2
            ? void 0
            : i2.call(t3);
        });
  }
  ...
  disconnectedCallback() {
    ...
    null === (t2 = this._$ES) ||
      ...
      t2.forEach((t3) => {
        var i2;
        return null === (i2 = t3.hostDisconnected) || void 0 === i2
          ? void 0
          : i2.call(t3);
      });
  }
  ...
  _$EO(t2, i2, s2 = l$2) {
    ...
    if (void 0 !== r2 && true === s2.reflect) {
      const h2 = (
        void 0 !==
        (null === (e2 = s2.converter) || void 0 === e2
          ? void 0
          : e2.toAttribute)
          ? s2.converter
          : n$2
      ).toAttribute(i2, s2.type);
      (this._$El = t2),
        null == h2 ? this.removeAttribute(r2) : this.setAttribute(r2, h2),
        (this._$El = null);
    }
  }
  _$AK(t2, i2) {
      ...
      const t3 = e2.getPropertyOptions(r2),
        h2 =
          'function' == typeof t3.converter
            ...
            : void 0 !==
              (null === (s2 = t3.converter) || void 0 === s2
                ? void 0
                : s2.fromAttribute)
            ? t3.converter
            : n$2;
      (this._$El = r2),
        (this[r2] = h2.fromAttribute(i2, t3.type)),
        (this._$El = null);
    }
  }
  requestUpdate(t2, i2, s2) {
    let e2 = true;
    void 0 !== t2 &&
      (((s2 = s2 || this.constructor.getPropertyOptions(t2)).hasChanged || a$1)(
        this[t2],
        i2,
      )
        ? (this._$AL.has(t2) || this._$AL.set(t2, i2),
          true === s2.reflect &&
            ...
            this._$EC.set(t2, s2)))
        : (e2 = false)),
      !this.isUpdatePending && e2 && (this._$E_ = this._$Ej());
  }
  async _$Ej() {
  ...
  performUpdate() {
    ...
    this.hasUpdated,
      this._$Ei &&
        (this._$Ei.forEach((t3, i3) => (this[i3] = t3)), (this._$Ei = void 0));
    let i2 = false;
    const s2 = this._$AL;
    try {
        ...
        i2
          ? (this.willUpdate(s2),
            null === (t2 = this._$ES) ||
              ...
              t2.forEach((t3) => {
                var i3;
                return null === (i3 = t3.hostUpdate) || void 0 === i3
                  ? void 0
                  : i3.call(t3);
              }),
            this.update(s2))
  ...
  _$AE(t2) {
    ...
    null === (i2 = this._$ES) ||
      ...
      i2.forEach((t3) => {
        var i3;
        return null === (i3 = t3.hostUpdated) || void 0 === i3
          ? void 0
          : i3.call(t3);
      }),
  ...
  update(t2) {
    void 0 !== this._$EC &&
      (this._$EC.forEach((t3, i2) => this._$EO(i2, this[i2], t3)),
      (this._$EC = void 0)),
      this._$Ek();
  }
  updated(t2) {}
...
(u$1[d$1] = true),
  (u$1.elementProperties = /* @__PURE__ */ new Map()),
  (u$1.elementStyles = []),
  (u$1.shadowRootOptions = { mode: 'open' }),
  null == o$2 || o$2({ ReactiveElement: u$1 }),
...
const i = window,
  s$1 = i.trustedTypes,
  e = s$1 ? s$1.createPolicy('lit-html', { createHTML: (t2) => t2 }) : void 0,
  o$1 = '$lit$',
  ...
  c = Array.isArray,
  v = (t2) =>
    c(t2) || 'function' == typeof (null == t2 ? void 0 : t2[Symbol.iterator]),
  a = '[ 	\n\f\r]',
  f = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,
  _ = /-->/g,
  m = />/g,
...
const V = (t2, i2) => {
  ...
  for (let i3 = 0; i3 < s2; i3++) {
    ...
    for (
      ;
      a2 < s3.length && ((u3.lastIndex = a2), (c2 = u3.exec(s3)), null !== c2);
      ...
      (a2 = u3.lastIndex),
        u3 === f
          ? '!--' === c2[1]
            ...
            ? (u3 = m)
            : void 0 !== c2[2]
            ? (y.test(c2[2]) && (l2 = RegExp('</' + c2[2], 'g')), (u3 = p))
            : void 0 !== c2[3] && (u3 = p)
          : u3 === p
          ? '>' === c2[0]
            ? ((u3 = null != l2 ? l2 : f), (v2 = -1))
            : void 0 === c2[1]
            ? (v2 = -2)
            : ((v2 = u3.lastIndex - c2[2].length),
              (d2 = c2[1]),
              (u3 = void 0 === c2[3] ? p : '"' === c2[3] ? $ : g))
          : u3 === $ || u3 === g
          ? (u3 = p)
          : u3 === _ || u3 === m
          ? (u3 = f)
    ...
    r2 +=
      u3 === f
        ? s3 + h
        : v2 >= 0
        ? (e2.push(d2), s3.slice(0, v2) + o$1 + s3.slice(v2) + n$1 + w2)
        : s3 + n$1 + (-2 === v2 ? (e2.push(void 0), i3) : w2);
  }
    ...
    for (; null !== (h2 = C.nextNode()) && v2.length < c2; ) {
      if (1 === h2.nodeType) {
          ...
          for (const i3 of h2.getAttributeNames())
            if (i3.endsWith(o$1) || i3.startsWith(n$1)) {
              ...
              if ((t3.push(i3), void 0 !== s2)) {
                const t4 = h2.getAttribute(s2.toLowerCase() + o$1).split(n$1),
                  i4 = /([.?@])?(.*)/.exec(s2);
                v2.push({
                  type: 1,
                  index: r2,
        ...
        if (y.test(h2.tagName)) {
          const t3 = h2.textContent.split(n$1),
            i3 = t3.length - 1;
          if (i3 > 0) {
        ...
        if (h2.data === l$1) v2.push({ type: 2, index: r2 });
        else {
          let t3 = -1;
...
function S(t2, i2, s2 = t2, e2) {
  ...
  let r2 =
    void 0 !== e2
      ? null === (o3 = s2._$Co) || void 0 === o3
        ? void 0
        : o3[e2]
      : s2._$Cl;
  const u3 = d(i2) ? void 0 : i2._$litDirective$;
  return (
    (null == r2 ? void 0 : r2.constructor) !== u3 &&
      (null === (n2 = null == r2 ? void 0 : r2._$AO) ||
        void 0 === n2 ||
        n2.call(r2, false),
      void 0 === u3 ? (r2 = void 0) : ((r2 = new u3(t2)), r2._$AT(t2, s2, e2)),
      void 0 !== e2
        ? ((null !== (l2 = (h2 = s2)._$Co) && void 0 !== l2
            ? l2
            : (h2._$Co = []))[e2] = r2)
        : (s2._$Cl = r2)),
    void 0 !== r2 && (i2 = S(t2, r2._$AS(t2, i2.values), r2, e2)),
    i2
  );
}
class M {
  ...
  u(t2) {
    ...
    const {
      ...
      o3 = (
        null !== (i2 = null == t2 ? void 0 : t2.creationScope) && void 0 !== i2
          ? i2
          : r
      ).importNode(s2, true);
    C.currentNode = o3;
    ...
    for (; void 0 !== u3; ) {
      if (l2 === u3.index) {
        let i3;
        2 === u3.type
          ? (i3 = new R(n2, n2.nextSibling, this, t2))
          : 1 === u3.type
          ? (i3 = new u3.ctor(n2, u3.name, u3.strings, this, t2))
          : 6 === u3.type && (i3 = new Z(n2, this, t2)),
          this._$AV.push(i3),
          (u3 = e2[++h2]);
      }
...
class R {
  constructor(t2, i2, s2, e2) {
    ...
    (this.type = 2),
      ...
      (this.options = e2),
      (this._$Cp =
        null === (o3 = null == e2 ? void 0 : e2.isConnected) ||
        void 0 === o3 ||
        o3);
  }
  get _$AU() {
    var t2, i2;
    return null !==
      (i2 = null === (t2 = this._$AM) || void 0 === t2 ? void 0 : t2._$AU) &&
      void 0 !== i2
      ? i2
      : this._$Cp;
  }
    ...
    const { values: s2, _$litType$: e2 } = t2,
      o3 =
        'number' == typeof e2
          ? this._$AC(t2)
          : (void 0 === e2.el &&
              (e2.el = N.createElement(P(e2.h, e2.h[0]), this.options)),
            e2);
  ...
  T(t2) {
    ...
    for (const o3 of t2)
      e2 === i2.length
        ? i2.push((s2 = new R(this.k(u2()), this.k(u2()), this, this.options)))
        : (s2 = i2[e2]),
        s2._$AI(o3),
        e2++;
    e2 < i2.length &&
  ...
  setConnected(t2) {
    ...
    void 0 === this._$AM &&
      ((this._$Cp = t2),
      null === (i2 = this._$AP) || void 0 === i2 || i2.call(this, t2));
  }
}
class k {
  ...
  _$AI(t2, i2 = this, s2, e2) {
    ...
    if (void 0 === o3)
      (t2 = S(this, t2, i2, 0)),
        (n2 = !d(t2) || (t2 !== this._$AH && t2 !== T)),
        n2 && (this._$AH = t2);
    else {
      const e3 = t2;
      let l2, h2;
      for (t2 = o3[0], l2 = 0; l2 < o3.length - 1; l2++)
        (h2 = S(this, e3[s2 + l2], i2, l2)),
          h2 === T && (h2 = this._$AH[l2]),
          n2 || (n2 = !d(h2) || h2 !== this._$AH[l2]),
          h2 === A
            ? (t2 = A)
            : t2 !== A && (t2 += (null != h2 ? h2 : '') + o3[l2 + 1]),
          (this._$AH[l2] = h2);
    }
    n2 && !e2 && this.j(t2);
  }
  j(t2) {
    t2 === A
      ...
      : this.element.setAttribute(this.name, null != t2 ? t2 : '');
  }
}
class H extends k {
  constructor() {
...
class z extends k {
  ...
  _$AI(t2, i2 = this) {
    var s2;
    if (
      (t2 = null !== (s2 = S(this, t2, i2, 0)) && void 0 !== s2 ? s2 : A) === T
    )
      return;
    const e2 = this._$AH,
      o3 =
      ...
      n2 = t2 !== A && (e2 === A || o3);
    o3 && this.element.removeEventListener(this.name, this, e2),
  ...
  handleEvent(t2) {
    ...
    'function' == typeof this._$AH
      ? this._$AH.call(
          null !==
            (s2 =
              null === (i2 = this.options) || void 0 === i2
                ? void 0
                : i2.host) && void 0 !== s2
            ? s2
            : this.element,
...
const D = (t2, i2, s2) => {
  var e2, o3;
  const n2 =
    null !== (e2 = null == s2 ? void 0 : s2.renderBefore) && void 0 !== e2
      ? e2
      : i2;
  let l2 = n2._$litPart$;
  if (void 0 === l2) {
    const t3 =
      null !== (o3 = null == s2 ? void 0 : s2.renderBefore) && void 0 !== o3
        ? o3
        : null;
    n2._$litPart$ = l2 = new R(
      i2.insertBefore(u2(), t3),
      t3,
      void 0,
      null != s2 ? s2 : {},
    );
...
class s extends u$1 {
  ...
  createRenderRoot() {
    ...
    return (
      (null !== (t2 = (e2 = this.renderOptions).renderBefore) &&
        void 0 !== t2) ||
  ...
  update(t2) {
    ...
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(t2),
      (this._$Do = D(i2, this.renderRoot, this.renderOptions));
  }
  connectedCallback() {
    var t2;
    super.connectedCallback(),
      null === (t2 = this._$Do) || void 0 === t2 || t2.setConnected(true);
  }
  disconnectedCallback() {
    var t2;
    super.disconnectedCallback(),
      null === (t2 = this._$Do) || void 0 === t2 || t2.setConnected(false);
  }
  render() {
    return T;
  }
...
(null !== (o2 = globalThis.litElementVersions) && void 0 !== o2
  ? o2
...
function Run(Glide2, Components, Events) {
  var Run2 = {
    ...
    isBound: function isBound() {
      return (
        Glide2.isType('slider') &&
        Glide2.settings.focusAt !== 'center' &&
        Glide2.settings.bound
      );
    },
  };
...
function Sizes(Glide2, Components, Events) {
  ...
  define(Sizes2, 'wrapperSize', {
    ...
    get: function get() {
      return (
        Sizes2.slideWidth * Sizes2.length +
  ...
  define(Sizes2, 'slideWidth', {
    ...
    get: function get() {
      return (
        Sizes2.width / Glide2.settings.perView -
  ...
  var Build2 = {
    ...
    typeClass: function typeClass() {
      Components.Html.root.classList.add(
        Glide2.settings.classes.type[Glide2.settings.type],
      );
    },
    /**
  ...
  var Clones2 = {
    ...
    collect: function collect() {
      ...
      if (slides.length !== 0) {
        ...
        for (
          var r2 = 0;
          r2 < Math.max(cloningRatio, Math.floor(perView / slides.length));
          r2++
        ) {
...
function Direction(Glide2, Components, Events) {
  var Direction2 = {
    ...
    addClass: function addClass() {
      Components.Html.root.classList.add(
        Glide2.settings.classes.direction[this.value],
      );
    },
    /**
...
function Translate(Glide2, Components, Events) {
  var Translate2 = {
    ...
    getTravelDistance: function getTravelDistance() {
      var travelDistance =
        Components.Sizes.slideWidth * Glide2.settings.perView;
      if (Components.Run.isOffset('>') || Components.Run.isOffset('|>')) {
