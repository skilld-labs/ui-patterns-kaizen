...
const BasicRender = (args) => {
  ...
  useEffect(() => {
    if (args.ajax) {
      ...
      if ((btn.querySelector(".a-button__icon--start") && btn.querySelector(".a-button__icon--end")) || (!btn.querySelector(".a-button__icon--start") && !btn.querySelector(".a-button__icon--end"))) {
