import { defRender } from "@skilld_storybook/plugins/skilld";
...
const randomDimension = (base, maxRatio = 1.5, minRatio = 0.5) => Math.floor(Math.random() * (base * minRatio - base * maxRatio) + base * maxRatio);
